...
if 'menu_data' not in st.session_state:
    st.session_state.menu_data = {
        ...
        "チキンフィレオ": "オーロラ、オニ、レタス、Mチキ",
        "FOF（フィレオフィッシュ）": "タルタル、FOF、ハーフチーズ",
        "BM（ビッグマック）": "BMソース、オニオン、細レタス、ピ×２、10、BMソース、オニ、細レタス、チーズ、10、ヒール",
        "Mチキ（補足）": "シャカチキ、チキンフィレオ、てりやきチキンに使用",
        "クリスプ（補足）": "マックチキン、チキチーに使用",
        "BLB":"ソース、オニ、レタス、チーズ、ベーコン、10",
        "ダブル肉厚":"緑ソース、上下、オニ、チーズ二枚上下、6二枚",
        "たまごベーコン":"緑ソース、上下、オニオン、細レタス、ベーコン、たまご、6",
    }
